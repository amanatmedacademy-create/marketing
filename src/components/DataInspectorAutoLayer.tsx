...
const ROUTES: Record<string, RouteInfo> = {
  ...
  '/analytics': { title: 'Аналитика', description: 'Сквозная аналитика рекламы и CRM-конверсий.', sources: ['marketing_ads', 'marketing_leads', 'IMDS Analytics'], fields: ['spend', 'impressions', 'clicks', 'crm_leads', 'appointments', 'arrived', 'sales', 'revenue', 'roas', 'romi'], technical: ['/api/analytics/overview', '/api/analytics/conversion-matrix'] },
