...
async function connect(button: HTMLButtonElement, card: HTMLElement) {
  ...
  try {
    ...
    card.classList.remove('integration-state-planned', 'integration-state-disconnected');
...
function activateCard(card: HTMLElement) {
  ...
  card.classList.remove('integration-state-planned', 'integration-state-connected');
